...
public class MahasiswaData {
    ...
    public void listAkunMahasiswa() throws IOException {
        FileReader file = new FileReader("D:\\richard\\College\\Semester 2\\Object Oriented Program\\oop-midtest-2020\\H071191055\\Academic System\\ListAkunMahasiswa.txt");
    ...
    public void listDetailMahasiswa() throws IOException {
        FileReader file = new FileReader("D:\\richard\\College\\Semester 2\\Object Oriented Program\\oop-midtest-2020\\H071191055\\Academic System\\DetailMahasiswa.txt");
        BufferedReader reader = new BufferedReader(file);
        String tempData[];
        while (reader.ready()) {
            tempData = reader.readLine().split(";");
